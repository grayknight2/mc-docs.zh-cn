...
ms.openlocfilehash: fa7db60e29f978dc3dc7c833394a6e292c4c4024
ms.sourcegitcommit: 9d9795f8a5b50cd5ccc19d3a2773817836446912
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/14/2020
ms.locfileid: "88228924"
---
...
若要显示当前的 Python 版本，请在 Azure CLI 中运行以下命令：

```azurecli
az webapp config show --resource-group <resource-group-name> --name <app-name> --query linuxFxVersion
```

若要显示所有支持的 Python 版本，请在 Azure CLI 中运行以下命令：
...
在 Azure CLI 中运行以下命令，将 Python 版本设置为 3.7：
...
可以通过提供自定义 Gunicorn 启动命令来控制容器的启动行为。 为此，请在 Azure CLI 中运行以下命令：
