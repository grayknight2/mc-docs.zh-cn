...
ms.author: v-yeche
ms.topic: how-to
ms.openlocfilehash: 32d1d505639ff8328597feac11ae39923f43b486
ms.sourcegitcommit: e633c458126612223fbf7a8853dbf19acc7f0fa5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/20/2020
ms.locfileid: "88655010"
---
...
* 命令行工具：
    * 可以使用 [Azure 命令行](https://docs.azure.cn/cli/?view=azure-cli-latest)或 [PowerShell](https://docs.microsoft.com/powershell/azure/) 来编写 Batch 脚本。
...
:::image type="content" source="./media/batch-rendering-using/batch-explorer-gallery.png" alt-text="Batch Explorer 库":::
